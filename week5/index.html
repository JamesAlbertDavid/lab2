...
<body>
    <div class="header">
        ...
        <div class="content">
            ...
            <h3>Bachelor of Science in Information Technology with specialization in Mobile and Internet Technology<br> Senior High School in <span>Rizal Technological Univercity</span> at Boni in Mandaluyong</h6>
        </div>
    </div>
    ...
    <section class="about">
        <div class="main">
            ...
            <div class="about-text">
                ...
                <p>As a first-year student at APC pursuing a degree in Information Technology, I am a tall individual who finds joy in activities like riding bicycles and engaging in video games such as Point Blank, Mobile Legend, Cabal, and more. My preference for simplicity extends to various aspects of my life. Apart from my academic pursuits, I take pleasure in cooking, with binagoongan being my favorite dish. My ultimate aspiration is to evolve into a full-time web developer, driven by a passion for the intricacies of web development.</p>
            </div>
        </div>
    </section>
